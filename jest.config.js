...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/g2/cnck7hy10f195kj30mkff7bw0000gp/T/jest_dy",
  ...
  // specified as % or a number. E.g. maxWorkers: 10% will use 10%
  // of your CPU amount + 1 as the maximum worker number. maxWorkers: 2
  ...
  testPathIgnorePatterns: ['/node_modules/', '/dev-packages/babel-plugin-jsx', '/packages/core'],
