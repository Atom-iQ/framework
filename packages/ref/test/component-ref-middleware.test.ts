...
//     }
//     const shareRef = componentRefMiddleware(mockComponentElement)
//     expect(shareRef(() => null)).toBeNull()
//   })
//
// eslint-disable-next-line max-len
...
//     const shareRef = componentRefMiddleware(mockComponentElement as RvdComponentNode)
//     shareRef(ref => ({ ...ref, functions: { mock: mockTestAttachedFn } }))
